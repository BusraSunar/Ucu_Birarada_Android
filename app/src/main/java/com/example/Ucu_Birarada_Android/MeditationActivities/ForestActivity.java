...
public class ForestActivity extends Activity {
    ...
    public void goBackToMeditation(View view) {
        onPause();
        onDestroy();
        Intent intent = new Intent(ForestActivity.this, MeditationActivity.class);
    ...
    private void checkInternet()
    {
        ...
        {
            androidx.appcompat.app.AlertDialog alertDialog = new androidx.appcompat.app.AlertDialog.Builder(ForestActivity.this).create();
